...
def extc_feature():
    c_l = read_file('/Users/dreameng/Downloads/020初赛数据/ccf_offline_stage1_train.csv')
    c_l2 = read_file2('/Users/dreameng/Downloads/020初赛数据/ccf_online_stage1_train.csv')
    c_l.extend(c_l2)
    try:
        feature_v_f = open('feature_values', 'wb')
